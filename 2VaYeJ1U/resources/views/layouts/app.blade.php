...
<head>
    ...
    <!-- color CSS -->
    <link href="{{asset('public/css/colors/blue-dark.css')}}" id="theme" rel="stylesheet">
...
<body class="fix-sidebar">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        @if(!empty($segments))
                            <ol class="breadcrumb">
                                <li {{ (( Request::segment(1)=='home') ? 'class=active' : '') }}><a href="{{url('user')}}">Dashboard</a></li>
    ...
    <!--Counter js -->
    <script src="{{asset('public/plugins/bower_components/waypoints/lib/jquery.waypoints.js')}}"></script>
    <script src="{{asset('public/plugins/bower_components/counterup/jquery.counterup.min.js')}}"></script>
    <!--Morris JavaScript -->
    ...
    <!-- chartist chart -->
    <script src="{{asset('public/plugins/bower_components/chartist-js/dist/chartist.min.js')}}"></script>
    <script src="{{asset('public/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js')}}"></script>
    <!-- Calendar JavaScript -->
    <script src="{{asset('public/plugins/bower_components/moment/moment.js')}}"></script>
    <script src="{{asset('public/plugins/bower_components/calendar/dist/fullcalendar.min.js')}}"></script>
    <script src="{{asset('public/plugins/bower_components/calendar/dist/cal-init.js')}}"></script>
    ...
    <script src="{{asset('public/plugins/bower_components/bootstrap-datepicker/bootstrap-datepicker.min.css')}}"></script>
